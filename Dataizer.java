...
public static  ArrayList<String> times  = new ArrayList<String>();
    public static ArrayList<String> desc  = new ArrayList<String>();
       public static ArrayList<String> posted  = new ArrayList<String>();
 ...
 public static void dateFixer(){
	for (int i = 0; i < dates.size(); i++){
	      try{
		  dates.set(i, ((dates.get(i)).substring(25,33)));
		}
  ...
  public static void organize (String fileName){
	...
	dateFixer();	  
     ...
     stateCount [1][1] = String.valueOf(Collections.frequency(state, "AK"));
	    //Arizona 3
  ...
  public static void main(String[]args){
      ...
      //   System.out.println( Arrays.toString((dates.subList(0, 800)).toArray())); 
